...
export function CtaButton({ filterPanel, toggleFilterPanel }) {
    return (
        <button className={`cta-button ${filterPanel && 'cta-button--selected'}`} onClick={toggleFilterPanel}>
            <p className={`cta-button__text ${filterPanel && 'cta-button__text--selected'}`}>Filters</p>
            <svg
                width={"15"}
                height={"11"}
                viewBox={"0 0 15 11"}
