...
export function CtaButton({ filterPanelOpen, toggleFilterPanel }) {
    return (
        <button className={`cta-button ${filterPanelOpen && 'cta-button--selected'}`} onClick={toggleFilterPanel}>
            <p className={`cta-button__text ${filterPanelOpen && 'cta-button__text--selected'}`}>Filters</p>
            <svg
                width={"15"}
                height={"11"}
                viewBox={"0 0 15 11"}
                ...
                className={`cta-button__icon ${filterPanelOpen && 'cta-button__icon--selected'}`}
            >
